...
<a target="_blank" href="https://jaywcjlove.github.io/maslink/?id=6747587746" title="Vidwall for macOS">
...
2. perf(wallpaper): Optimize settings list performance by using recycled NSTableView
3. style: Refine sidebar icon visuals
...
1. fix: fix issue where the menu was not locked when loading files.
2. perf: optimize list display performance.
3. perf: optimize video fade-in and fade-out settings
